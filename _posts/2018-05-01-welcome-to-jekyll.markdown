...
![My helpful screenshot]({{ "patrickschulz-26/pschulz/assets/ava3D.png" | absolute_url }})

the example for 2D is seen below:

![My helpful screenshot]({{ "patrickschulz-26/pschulz/assets/ava2D.png" | absolute_url }})
